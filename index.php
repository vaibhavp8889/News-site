            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    include 'config.php';
                            ...
                            $offset = ($page -1) * $limit;
                            $sql = "SELECT post.post_id,post.title,post.description,post.post_date,post.post_img,post.author,category.category_name,user.username,post.category FROM post
